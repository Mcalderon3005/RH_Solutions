...
import '/walkthroughs/horario.dart';
...
class _HorarioWidgetState extends State<HorarioWidget> {
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'HORARIO_PAGE_question_mark_ICN_ON_TAP');
                                      logFirebaseEvent(
                                          'IconButton_start_walkthrough');
                                      safeSetState(() =>
                                          _model.horarioController =
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          height: MediaQuery.sizeOf(context).height * 0.798,
                          decoration: BoxDecoration(
                            color: FlutterFlowTheme.of(context)
                                .secondaryBackground,
                                        ...
                                        return SingleChildScrollView(
                                          child: Column(
                                            ...
                                            children: List.generate(
                                                horarioslistum2.length,
                                                (horarioslistum2Index) {
                                              final horarioslistum2Item =
                                                  horarioslistum2[
                                                      horarioslistum2Index];
                                              return ListView(
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.horarioController = null);
        },
        onSkip: () {
          return true;
        },
