...
import '/walkthroughs/ttl_recuperar_contrasena_mobil.dart';
import '/index.dart';
...
class _RecuperarContrasenaWidgetState extends State<RecuperarContrasenaWidget> {
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      HapticFeedback.lightImpact();
                                      logFirebaseEvent('Button_auth');
                                      if (_model.emailAddressTextController2
                                          .text.isEmpty) {
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
                                          SnackBar(
                              ...
                              column5kdao0ar,
                              _model.ttlRecuperarContrasenaMobilController,
                            ),
                          ),
                        ),
                      ],
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(
              () => _model.ttlRecuperarContrasenaMobilController = null);
        },
        onSkip: () {
          return true;
        },
