...
import '/walkthroughs/ttl_index_empleado.dart';
import '/index.dart';
...
class _IndexEmpleadoWidgetState extends State<IndexEmpleadoWidget> {
                          ...
                          children: [
                            Align(
                              ...
                              child: Text(
                                ...
                                textA03sn66l,
                                _model.ttlIndexEmpleadoController,
                              ),
                            ),
                          ],
                        ),
                      ...
                      Row(
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'INDEX_EMPLEADO_PAGE__BTN_ON_TAP');
                              logFirebaseEvent('Button_navigate_to');
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        listViewUsersRecord.estaActivo ==
                                                                                true
                                                                            ? 'Activo'
                                                                            : 'Inactivo',
                                                                        style: FlutterFlowTheme.of(context)
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.ttlIndexEmpleadoController = null);
        },
        onSkip: () {
          return true;
        },
