  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> logSesionesUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final logSesionesUsersRecord = logSesionesUsersRecordList.isNotEmpty
            ? logSesionesUsersRecordList.first
            : null;
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'LOG_SESIONES_Container_z03124dn_ON_TAP');
                                            logFirebaseEvent(
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        onChanged: (_) =>
                                                          ...
                                                          () async {
                                                            logFirebaseEvent(
                                                                'LOG_SESIONES_TextField_m8cqkpy9_ON_TEXTF');
                                                            logFirebaseEvent(
