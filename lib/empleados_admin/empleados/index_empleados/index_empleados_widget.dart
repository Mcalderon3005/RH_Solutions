...
class IndexEmpleadosWidget extends StatefulWidget {
  ...
  static String routeName = 'Index_Empleados';
  static String routePath = 'indexEmpleados';
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'INDEX_EMPLEADOS_Container_ksbtojqu_ON_TA');
                                                  logFirebaseEvent(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child:
                                                              ...
                                                              onChanged: (_) =>
                                                                ...
                                                                () async {
                                                                  logFirebaseEvent(
                                                                      'INDEX_EMPLEADOS_TextField_6uu8ap8m_ON_TE');
                                                                  logFirebaseEvent(
                                                    ...
                                                    itemBuilder: (context,
                                                      ...
                                                      return Padding(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'INDEX_EMPLEADOS_Container_l1w1v1wg_ON_TA');
                                                            logFirebaseEvent(
