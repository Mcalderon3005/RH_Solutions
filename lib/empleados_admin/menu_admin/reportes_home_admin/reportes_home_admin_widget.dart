...
class ReportesHomeAdminWidget extends StatefulWidget {
  const ReportesHomeAdminWidget({super.key});

  static String routeName = 'reportesHomeAdmin';
  static String routePath = 'reportesHomeAdmin';

  @override
  State<ReportesHomeAdminWidget> createState() =>
      _ReportesHomeAdminWidgetState();
}

class _ReportesHomeAdminWidgetState extends State<ReportesHomeAdminWidget> {
  late ReportesHomeAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportesHomeAdminModel());
                              ...
                              child: Column(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'REPORTES_HOME_ADMIN_Container_0d8qzkn7_O');
                                      logFirebaseEvent('Container_navigate_to');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'REPORTES_HOME_ADMIN_Container_2jyagg8j_O');
                                      logFirebaseEvent('Container_navigate_to');

                                      context
                                          .goNamed(LogSesionesWidget.routeName);
                                    },
                                    child: Material(
                                      color: Colors.transparent,
                                      elevation: 2.0,
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'REPORTES_HOME_ADMIN_Container_y9na9itn_O');
                                      logFirebaseEvent('Container_navigate_to');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'REPORTES_HOME_ADMIN_Container_7hddvax7_O');
                                      logFirebaseEvent('Container_navigate_to');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'REPORTES_HOME_ADMIN_Container_uzwv4j1s_O');
                                      logFirebaseEvent('Container_navigate_to');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'REPORTES_HOME_ADMIN_Container_jg3ytznc_O');
                                      logFirebaseEvent('Container_navigate_to');
