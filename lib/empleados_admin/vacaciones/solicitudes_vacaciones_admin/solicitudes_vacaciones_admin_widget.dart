...
import '/walkthroughs/solicitudes_vacaciones_admin.dart';
...
class _SolicitudesVacacionesAdminWidgetState
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (_model.userInfoSingle?.isLoggedIn != true) {
        logFirebaseEvent('solicitudesVacacionesAdmin_auth');
      ...
      logFirebaseEvent('solicitudesVacacionesAdmin_action_block');
                      ...
                      Row(
                        ...
                        children: [
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'SOLICITUDES_VACACIONES_ADMIN_arrow_back_');
                          ...
                          Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'SOLICITUDES_VACACIONES_ADMIN_question_ma');
                                logFirebaseEvent(
                                    'IconButton_start_walkthrough');
                                safeSetState(() => _model
                                        .solicitudesVacacionesAdminController =
                                    createPageWalkthrough(context));
                                _model.solicitudesVacacionesAdminController
                          ...
                          children: [
                            ...
                            Material(
                              ...
                              child: Container(
                                ...
                                height:
                                    MediaQuery.sizeOf(context).height * 0.813,
                                decoration: BoxDecoration(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            valueOrDefault<String>(
                                                                              listViewSolicitudVacacionesRecord.empleadoNombre,
                                                                              'Nombre',
                                                                            ),
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            listViewSolicitudVacacionesRecord.estadoRevision == true
                                                                                ? 'Revisado'
                                                                                : 'Pendiente',
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  font: GoogleFonts.manrope(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            listViewSolicitudVacacionesRecord.estadoAprobacion == true
                                                                                ? 'Aprobado'
                                                                                : 'Denegado',
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  font: GoogleFonts.manrope(
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(
              () => _model.solicitudesVacacionesAdminController = null);
        },
        onSkip: () {
          return true;
        },
