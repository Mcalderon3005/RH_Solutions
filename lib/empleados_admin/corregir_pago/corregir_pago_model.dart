...
import '/index.dart';
import 'corregir_pago_widget.dart' show CorregirPagoWidget;
import 'package:tutorial_coach_mark/tutorial_coach_mark.dart'
    show TutorialCoachMark;
import 'package:flutter/material.dart';

class CorregirPagoModel extends FlutterFlowModel<CorregirPagoWidget> {
  ///  State fields for stateful widgets in this page.

  TutorialCoachMark? corregirPagoController;
  // Stores action output result for [Firestore Query - Query a collection] action in corregirPago widget.
  ...
  bool isDataUploading_uploadDataN0n2 = false;
  FFUploadedFile uploadedLocalFile_uploadDataN0n2 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataN0n2 = '';
  ...
  bool isDataUploading_uploadDataN0n = false;
  FFUploadedFile uploadedLocalFile_uploadDataN0n =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataN0n = '';
