...
import '/walkthroughs/definir_actividad_admin.dart';
...
class _DefinirActividadAdminWidgetState
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      logFirebaseEvent('DefinirActividadAdmin_action_block');
                    ...
                    Row(
                      ...
                      children: [
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'DEFINIR_ACTIVIDAD_ADMIN_arrow_back_ICN_O');
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'DEFINIR_ACTIVIDAD_ADMIN_question_mark_IC');
                                logFirebaseEvent(
                                    'IconButton_start_walkthrough');
                                safeSetState(() =>
                                    _model.definirActividadAdminController =
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Container(
                                                ...
                                                textField14jeoerw,
                                                _model
                                                    .definirActividadAdminController,
                                              ),
                                            ),
                                            FFButtonWidget(
                                              onPressed: () async {
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        FlutterFlowIconButton(
                                                          ...
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'DEFINIR_ACTIVIDAD_ADMIN_edit_square_ICN_');
                                                            logFirebaseEvent(
                                                                'IconButton_navigate_to');
                                                ...
                                                child: InkWell(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'DEFINIR_ACTIVIDAD_ADMIN_Column_gqz6ceg6_');
                                                        logFirebaseEvent(
                                                            'Column_navigate_to');
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.definirActividadAdminController = null);
        },
        onSkip: () {
          return true;
        },
