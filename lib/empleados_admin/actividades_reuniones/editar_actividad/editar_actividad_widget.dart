...
import '/walkthroughs/ttleditar_actividad.dart';
import 'dart:ui';
import '/index.dart';
...
class EditarActividadWidget extends StatefulWidget {
  const EditarActividadWidget({
    ...
    required this.asuntoReunion,
    required this.descripcionReunion,
    required this.asistentesReunion,
    required this.reuRef,
    required this.nombreCreador,
    bool? estadoActividad,
  }) : this.estadoActividad = estadoActividad ?? true;

  final DateTime? fechaReunion;
  final String? enlaceReunion;
  final String? asuntoReunion;
  final String? descripcionReunion;
  final List<String>? asistentesReunion;
  final DocumentReference? reuRef;
  final String? nombreCreador;
  final bool estadoActividad;

  static String routeName = 'editarActividad';
  static String routePath = 'editarActividad';
...
class _EditarActividadWidgetState extends State<EditarActividadWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'editarActividad'});
    _model.txtEnlaceTextController1 ??=
        TextEditingController(text: widget.enlaceReunion);
    _model.txtEnlaceFocusNode1 ??= FocusNode();

    _model.txtAsuntoTextController1 ??=
        TextEditingController(text: widget.asuntoReunion);
    _model.txtAsuntoFocusNode1 ??= FocusNode();

    _model.textController3 ??=
        TextEditingController(text: widget.descripcionReunion);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.switchValue = widget.estadoActividad;
    _model.txtEnlaceTextController2 ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.enlaceReunion,
      'Enlace',
    ));
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'EDITAR_ACTIVIDAD_PAGE_VOLVER_BTN_ON_TAP');
                            logFirebaseEvent('Button_navigate_to');

                            context
                                .pushNamed(DefinirActividadBUWidget.routeName);
                          },
                          text: 'Volver',
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    ...
                                    textGglepnlc,
                                    _model.ttleditarActividadController,
                                  ),
                                ),
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'EDITAR_ACTIVIDAD_calendar_month_ICN_ON_T');
                                              logFirebaseEvent(
                                      ...
                                      Padding(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          ...
                                          options: widget.asistentesReunion!,
                                          ...
                                          hintText: 'Participantes Actuales',
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'EDITAR_ACTIVIDAD_ACTUALIZAR_ACTIVIDAD_BT');
                                      if ((_model.checkboxListTileCheckedItems2
                                        ...
                                        await widget.reuRef!.update({
                                          ...createReunionesRecordData(
                                            nombreCreador:
                                                widget.nombreCreador,
                                            fechaReunion:
                                                _model.datePicked1 == null
                                                    ? widget.fechaReunion
                                                    : _model.datePicked1,
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'EDITAR_ACTIVIDAD_question_ICN_ON_TAP');
                ...
                children: [
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('EDITAR_ACTIVIDAD_PAGE__BTN_ON_TAP');
                          logFirebaseEvent('Button_navigate_to');

                          context
                              .pushNamed(DefinirActividadAdminWidget.routeName);
                        },
                        text: '',
                        icon: Icon(
                          Icons.arrow_back,
                                            ...
                                            ...createReunionesRecordData(
                                              ...
                                              fechaReunion:
                                                  _model.datePicked2 == null
                                                      ...
                                                      : _model.datePicked2,
                                              asunto: _model
                                                  .txtAsuntoTextController2
                                                  .text,
                                              descripcion:
                                                  _model.textController6.text,
                                              estaActivo: _model.switchValue,
                                              enlaceReunion: _model
                                                  .txtEnlaceTextController2
                                                  .text,
                                            ),
                                            ...mapToFirestore(
                                              {
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.ttleditarActividadController = null);
        },
        onSkip: () {
          return true;
        },
