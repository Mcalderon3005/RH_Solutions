...
import '/walkthroughs/ttl_crear_pago.dart';
import '/index.dart';
...
class _CrearPagoWidgetState extends State<CrearPagoWidget>
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        ...
                                        options: ['Salario', 'Bonificacion'],
                                        onChanged: (val) => safeSetState(
                                            () => _model.drdTipoValue = val),
                                        width: 200.0,
                                        height: 78.96,
                                        ...
                                        hintText: 'Seleccione el tipo de pago',
                                        icon: Icon(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await PagosRecord.collection
                                      ...
                                      .set(createPagosRecordData(
                                        ...
                                        nombreEmpleado: _model.drdEmpleadoValue,
                                        apellidoEmpleado:
                                ...
                                options: FFButtonOptions(
                                  width:
                                      MediaQuery.sizeOf(context).width * 0.422,
                                  height: 48.0,
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREAR_PAGO_PAGE_question_ICN_ON_TAP');
                                  logFirebaseEvent(
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.ttlCrearPagoController = null);
        },
        onSkip: () {
          return true;
        },
