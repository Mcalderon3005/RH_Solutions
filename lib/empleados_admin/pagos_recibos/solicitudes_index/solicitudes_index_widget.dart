...
import '/walkthroughs/solicitudes_index.dart';
...
class _SolicitudesIndexWidgetState extends State<SolicitudesIndexWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      logFirebaseEvent('Solicitudes_Index_action_block');
                      ...
                      Row(
                        ...
                        children: [
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'SOLICITUDES_INDEX_arrow_back_ICN_ON_TAP');
                              logFirebaseEvent('IconButton_navigate_to');

                              context.pushNamed(FacturacionWidget.routeName);
                            },
                          ),
                          Padding(
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              listViewSolicitudCambioPagoRecord.estado == true ? 'Revisada' : 'Pendiente',
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    font: GoogleFonts.manrope(
                                                                                      fontWeight: FlutterFlowTheme.of(context).bodyMedium.fontWeight,
                                                                                      fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('SOLICITUDES_INDEX_EDITAR_PAGO_BTN_ON_TAP');
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('SOLICITUDES_INDEX_MARCAR_COMO_REVISADO_B');
                                                                            logFirebaseEvent('Button_backend_call');

                                                                            await listViewSolicitudCambioPagoRecord.reference.update(createSolicitudCambioPagoRecordData(
                                                                              estado: true,
                                                                            ));
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'SOLICITUDES_INDEX_question_mark_ICN_ON_T');
                                logFirebaseEvent(
                                    'IconButton_start_walkthrough');
                                safeSetState(() =>
                                    _model.solicitudesIndexController =
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.solicitudesIndexController = null);
        },
        onSkip: () {
          return true;
        },
