...
import '/walkthroughs/ttllog_usuarios_creacion11.dart';
...
class _LogUsuariosCreacionWidgetState extends State<LogUsuariosCreacionWidget> {
                        ...
                        Flexible(
                          child: Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'LOG_USUARIOS_CREACION_delete_ICN_ON_TAP');
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          ...
                          text68541h3u,
                          _model.ttllogUsuariosCreacion11Controller,
                        ),
                      ],
                    ),
                  ),
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'LOG_USUARIOS_CREACION_question_ICN_ON_TA');
                    ...
                    Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'LOG_USUARIOS_CREACION_PAGE__BTN_ON_TAP');
                            logFirebaseEvent('Button_navigate_to');
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.ttllogUsuariosCreacion11Controller = null);
        },
        onSkip: () {
          return true;
        },
