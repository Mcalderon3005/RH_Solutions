...
import '/walkthroughs/ttl_log_horarios_errores.dart';
import '/index.dart';
...
class _LogHorariosErroresWidgetState extends State<LogHorariosErroresWidget> {
                      ...
                      children: [
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'LOG_HORARIOS_ERRORES_PAGE__BTN_ON_TAP');
                        ...
                        Flexible(
                          child: Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'LOG_HORARIOS_ERRORES_delete_ICN_ON_TAP');
                      ...
                      children: [
                        Align(
                          ...
                          child: Text(
                            ...
                            textNcoe5078,
                            _model.ttlLogHorariosErroresController,
                          ),
                        ),
                      ],
                    ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'LOG_HORARIOS_ERRORES_Icon_estbpbrz_ON_TA');
                  ...
                  children: [
                    ...
                    Material(
                      ...
                      child: Container(
                        ...
                        height: MediaQuery.sizeOf(context).height * 0.692,
                        decoration: BoxDecoration(
                          color:
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 10.0, 0.0, 0.0),
                                            child: StreamBuilder<
                                                List<HorarioErroresRecord>>(
                                              stream:
                                                  queryHorarioErroresRecord()
                                                    ..listen((snapshot) {
                                                      List<HorarioErroresRecord>
                                                          listViewHorarioErroresRecordList =
                                                          snapshot;
                                                      if (_model.listViewPreviousSnapshot !=
                                                              null &&
                                                          !const ListEquality(
                                                                  HorarioErroresRecordDocumentEquality())
                                                              .equals(
                                                                  listViewHorarioErroresRecordList,
                                                                  _model
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                return ListView.builder(
                                                  ...
                                                  itemBuilder:
                                                    ...
                                                    final listViewHorarioErroresRecord =
                                                        listViewHorarioErroresRecordList[
                                                            listViewIndex];
                                                    return Padding(
                                                      padding:
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'LOG_HORARIOS_ERRORES_question_ICN_ON_TAP');
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.ttlLogHorariosErroresController = null);
        },
        onSkip: () {
          return true;
        },
