...
import '/empleados_admin/reportes/componentes/log_error_horario_detalles/log_error_horario_detalles_widget.dart';
          ...
          child: Column(
            ...
            children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'LOG_HORARIOS_ERRORES_VOLVER_BTN_ON_TAP');
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child:
                                                                ...
                                                                onChanged: (_) =>
                                                                  ...
                                                                  () async {
                                                                    logFirebaseEvent(
                                                                        'LOG_HORARIOS_ERRORES_TextField_h18utfo1_');
                                                                    logFirebaseEvent(
                ...
                child: Visibility(
                  ...
                  child: Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final erroresListU =
                            _model.horarioErroresListT.toList();

                        return FlutterFlowDataTable<HorarioErroresRecord>(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'LOG_HORARIOS_ERRORES_Icon_itah0v5m_ON_TA');
                                          ...
                                          return GestureDetector(
                                            ...
                                            child: Padding(
                                              padding: MediaQuery.viewInsetsOf(
                                                  context),
                                              child:
                                                  LogErrorHorarioDetallesWidget(
                                                fechaCreacion: erroresListUItem
                                                    .fechaActual!,
                                                fechaInicioJornada:
                                                    erroresListUItem
                                                        .horaEstado!,
              ...
              Align(
                alignment: AlignmentDirectional(1.0, 0.0),
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 20.0, 30.0, 0.0),
