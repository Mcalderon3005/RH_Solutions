...
import '/walkthroughs/ttl_recuperar_contrasena.dart';
import '/index.dart';
...
class _RecuperarContrasenaWidgetState extends State<RecuperarContrasenaWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'RecuperarContrasena'});
                          ...
                          children: [
                            Container(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'RECUPERAR_CONTRASENA_arrow_back_ICN_ON_T');
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  ...
                                  textArkf8p47,
                                  _model.ttlRecuperarContrasenaController,
                                ),
                              ),
                            ),
                            Align(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              textFieldYta372zz,
                                              _model
                                                  .ttlRecuperarContrasenaController,
                                            ),
                                          ),
                                        ],
                                      ),
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'RECUPERAR_CONTRASENA_ENVIAR_CORREO_BTN_O');
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'RECUPERAR_CONTRASENA_question_ICN_ON_TAP');
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.ttlRecuperarContrasenaController = null);
        },
        onSkip: () {
          return true;
        },
