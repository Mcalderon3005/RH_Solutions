...
import '/walkthroughs/ttl_editar_perfil.dart';
import '/index.dart';
...
class _EditarPerfilWidgetState extends State<EditarPerfilWidget> {
            ...
            child: StreamBuilder<List<UsersRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                final conditionalBuilderUsersRecord =
                    conditionalBuilderUsersRecordList.isNotEmpty
                        ? conditionalBuilderUsersRecordList.first
                        : null;
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'EDITAR_PERFIL_PAGE_arrow_back_ICN_ON_TAP');
                                          logFirebaseEvent(
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          ...
                                          textPmxm6w9g,
                                          _model.ttlEditarPerfilController,
                                        ),
                                      ),
                                    ),
                                    Column(
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'EDITAR_PERFIL_GUARDAR_CAMBIOS_BTN_ON_TAP');
                                            logFirebaseEvent(
                                                'Button_backend_call');
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'EDITAR_PERFIL_PAGE_question_ICN_ON_TAP');
                                            logFirebaseEvent(
                                                'IconButton_start_walkthrough');
                                            safeSetState(() => _model
                                                    .ttlEditarPerfilController =
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.ttlEditarPerfilController = null);
        },
        onSkip: () {
          return true;
        },
