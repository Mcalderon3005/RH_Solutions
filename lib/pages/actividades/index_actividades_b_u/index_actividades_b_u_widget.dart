...
import 'index_actividades_b_u_model.dart';
export 'index_actividades_b_u_model.dart';

class IndexActividadesBUWidget extends StatefulWidget {
  const IndexActividadesBUWidget({super.key});

  static String routeName = 'indexActividadesBU';
  static String routePath = 'indexActividadesBU';

  @override
  State<IndexActividadesBUWidget> createState() =>
      _IndexActividadesBUWidgetState();
}

class _IndexActividadesBUWidgetState extends State<IndexActividadesBUWidget> {
  late IndexActividadesBUModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IndexActividadesBUModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'indexActividadesBU'});
                              ...
                              children: [
                                Container(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'INDEX_ACTIVIDADES_B_U_arrow_back_ICN_ON_');
                                      logFirebaseEvent(
                                            ...
                                            itemBuilder:
                                              ...
                                              return Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'INDEX_ACTIVIDADES_B_U_Container_ag3pcj48');
                                                    logFirebaseEvent(
