...
import '/walkthroughs/ttl_cambiar_contra.dart';
import '/index.dart';
...
class _CambiarContrasenaWidgetState extends State<CambiarContrasenaWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CambiarContrasena'});
              ...
              Column(
                ...
                children: [
                        ...
                        children: [
                          Container(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'CAMBIAR_CONTRASENA_arrow_back_ICN_ON_TAP');
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          'Te enviaremos un correo para que puedas cambiar la contraseña',
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            textFieldIgescd9n,
                                            _model.ttlCambiarContraController,
                                          ),
                                        ),
                                      ],
                                    ),
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CAMBIAR_CONTRASENA_ENVIAR_CORREO_BTN_ON_');
                                  logFirebaseEvent('Button_haptic_feedback');
                                  HapticFeedback.lightImpact();
                                  logFirebaseEvent('Button_auth');
                                  if (_model.emailAddressTextController1.text
                                      .isEmpty) {
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 220.0, 30.0, 0.0),
                      child: FlutterFlowIconButton(
                        borderRadius: 8.0,
                        buttonSize: 40.0,
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'CAMBIAR_CONTRASENA_question_ICN_ON_TAP');
                          logFirebaseEvent('IconButton_start_walkthrough');
                          safeSetState(() => _model.ttlCambiarContraController =
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                logFirebaseEvent('Button_auth');
                                if (_model
                                    .emailAddressTextController2.text.isEmpty) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Email required!',
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.ttlCambiarContraController = null);
        },
        onSkip: () {
          return true;
        },
