...
const kUserKey = "38ec7878-0b6b-49bd-bae3-cbc8873b5876";
const kAPIKey =
  "os_v2_app_xxcupvpn2zbcjb2ixihn7xg3iiuymjj3mu3eqa5ynzvuuvnufhlnxvboezipcjl44s6tmjnqhwn25ufl7gidgdb7scik6cdonr5ldiq";
...
exports.addUser = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    const createdUser = await client.createUser(
      "bdc547d5-edd6-4224-8748-ba0edfdcdb42",
      user,
    );
...
exports.deleteUser = functions.https.onCall(async (data, context) => {
  ...
  const url = `https://api.onesignal.com/apps/bdc547d5-edd6-4224-8748-ba0edfdcdb42/users/by/external_id/${data.user_id}`;
